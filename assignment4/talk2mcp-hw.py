    ...
    try:
        ...
        async with stdio_client(server_params) as (read, write):
            ...
            async with ClientSession(read, write) as session:
                ...
                system_prompt = f"""You are an AI agent solving problems in iterations. You have access to various tools to assist you.
...
- Only give FINAL_ANSWER when you have completed all necessary calculations and actions with the tools.
- Do not repeat function calls with the same parameters.
- You may have to store the sum of exponentials of ASCII values of characters in a variable and use it later.
- Follow the order of tools strictly as per the query.

Examples:
- FUNCTION_CALL: add|5|3
- FUNCTION_CALL: strings_to_chars_to_int|BHARAT
- FUNCTION_CALL: int_list_to_exponential_sum|[73, 78, 68, 73, 65]
- FUNCTION_CALL: open_paint
- FUNCTION_CALL: draw_rectangle|200|200|400|400
- FUNCTION_CALL: add_text_in_paint|24440777.89
- FUNCTION_CALL: send_mail_to_gmail|bhole.atul@gmail.com|some_valid_subject|24440777.89


DO NOT include any explanations or additional text.
Your entire response should be a single line starting with either FUNCTION_CALL: or FINAL_ANSWER:"""

                query1 = """Find the ASCII values of characters in INDIA, calculate sum of exponentials of those values, open MSPaint, 
                draw rectangle in Microsoft Paint with coordinates 200|200|500|400 and Add the sum of exponentials as text to the canvas in Microsoft Paint."""

                query_working_paint = """Find the ASCII values of characters in BHARAT, 
                calculate the sum of exponentials of those values, 
                open Microsoft Paint, 
                draw a rectangle with coordinates 200, 200, 500, 400, 
                and add the sum of exponentials as text with prefix 'Final Answer-:- ' to the canvas in Microsoft Paint."""

                query_working_email = """Find the ASCII values of characters in BHARAT, 
                calculate the sum of exponentials of those values, 
                and send the sum of exponentials as subject and body to bhole.atul@gmail.com"""
                logging.info("Starting iteration loop...")

                query = """Find the ASCII values of characters in BHARAT, 
                calculate the sum of exponentials of those values, 
                open Microsoft Paint, 
                draw a rectangle with coordinates 200, 200, 500, 400, 
                add the sum of exponentials as text with prefix 'Final Answer-:- ' to the canvas in Microsoft Paint,
                and send the sum of exponentials as body with an appropriate subject to bhole.atul@gmail.com"""
                    ...
                    if response_text.startswith("FUNCTION_CALL:"):
                        ...
                        try:
                            ...
                            if hasattr(result, 'content'):
                                logging.info("DEBUG: Result has content attribute")
